...
import { Car, Mail, Lock, Loader2, Phone, User, FileText } from "lucide-react";
...
export default function DriverRegister() {
  ...
  const handleDriverProfileSubmit = async (e) => {
    e.preventDefault();
    setError("");
    setLoading(true);
  ...
  return (
    <AuthLayout
      ...
      subtitle="Sign up to start earning with Hy3N"
      footer={
        <>
